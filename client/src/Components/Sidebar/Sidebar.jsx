...
export default function Sidebar() {
  return (
    <div className="z-50 fixed top-0 w-60 h-full overflow-y border-r border-gray-800 p-8 flex flex-col justify-between bg-[#440823] transition-all duration-500 lg:left-0 ">
      <div>
